  ...
  return (
    <div className="w-full flex justify-between items-center p-4 sm:p-6 sm:px-24 absolute top-0">
      ...
      bg-black text-white relative group">
        ...
        <div className="absolute hidden group-hover:block top-0 r-0 z-10 text-black rounded pt-10">
      ...
      rounded-full px-6 py-2 text-gray-700 hover:bg-gray-100 transition-all cursor-pointer">
